 ...
 * the background color of a placementButton, even if it is disabled. Without the hack and with
 * Nimbus LookAndFeel it's not so easy to accomplish that functionality.
 * @author Timur Saglam
 */
public class PlacementButton extends JButton {
	...
	public boolean isHackyEnabled() {
		...
		// original isEnabled method is overwritten, it breaks some functionality (e.g.updating the
		// background):
		return enabled;
	}
}
