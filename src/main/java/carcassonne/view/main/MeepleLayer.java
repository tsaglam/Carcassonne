...
public class MeepleLayer extends JPanel {
    ...
    public void changeZoomLevel(int zoomLevel) {
        this.zoomLevel = zoomLevel;
        placeholders.forEach(it -> it.changeShape(zoomLevel));
    ...
    public void refreshLayer() {
        meeplePanels.forEach(MeepleDepictionPanel::refreshAll);
    }
    ...
    public void resetLayer() {
        meeplePanels.forEach(MeepleDepictionPanel::resetAll);
    }
