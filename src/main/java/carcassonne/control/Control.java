...
public class Control extends MainController {
	...
	public void newGame(int playerCount) {
		...
		round = new Round2(playerCount, grid);
		gui.rebuildLabelGrid();
		gui.set(grid.getFoundation(), options.gridCenterX, options.gridCenterY);
