...
public class GridPattern {
    ...
    /**
     * Disburses complete patterns. Gives every involved player points if he is one of the players with the maximal
     * amount of meeples on the pattern. Removes the meeple placement and returns them to the players. Can only be
     * called once in the lifetime of a GridPttern object.
     */
    ...
    /**
     * Checks whether a specific player is involved in the occupation of the pattern. That means he has at least one
     * meeple on the pattern.
